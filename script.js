...
function aguasmais() {
    asideaguas.innerHTML = `<h3><input type="button" value="V" class="aguas" onclick="aguasmenos()"> Águas Sulfurosas x Águas Termais</h3>
        <p>É muito comum que as pessoas se confundam e não saibam a diferença entre águas termais e águas sulfurosas. Por isso, é importante ressaltar e diferenciar esses dois tipos de água.</p>
